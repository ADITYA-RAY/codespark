                                    ...
                                    <div className="carousel-item active">
                                        <div className="article-card"data-aos="fade-up" >
                                            ...
                                            <div className="article-title">
                                                This is my first article on codespark!
                                            </div>
                                            <div className="article-intro">
                                                lorem ipsum doloe sit amet.lorem ipsum doloe sit amet.lorem ipsum doloe sit amet.
                                                lorem ipsum doloe sit amet.
                                            </div>
                                            <div className="article-readmore-btn">
                                                Read more...
                                            </div>
