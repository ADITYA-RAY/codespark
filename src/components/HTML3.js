                    ...
                    <div class="col-sm">
                        <div className="HTMLCardIndex">
                            ...
                            <ul className="nobullets">
                                <li> <a className="tbl tablinks" href="#learnmodule" onClick={() => { sendopenCity("tab1", '0') }} id="defaultOpen"><i class="fa fa-cube"></i>{props.infot.line1} </a></li>
                                <li> <a className="tbl tablinks " href="#learnmodule" onClick={() => { sendopenCity("tab2", '1') }} ><i class="fa fa-cube"></i>{props.infot.line2} </a></li>
                                <li><a className="tbl tablinks" href="#learnmodule" onClick={() => { sendopenCity("tab3", '2') }} ><i class="fa fa-cube"></i> {props.infot.line3}</a></li>
                                <li><a className="tbl tablinks " href="#learnmodule" onClick={() => { sendopenCity("tab4", '3') }} ><i class="fa fa-cube"></i> {props.infot.line4}</a></li>
                            </ul>
