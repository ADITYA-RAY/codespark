    ...
    <div>
      <nav id="navbar" className="navbar fixed-top navbar-expand-lg navbar-dark HTMLnav" >
        ...
        <li className="navbar-brand ml23">
          <a className="nav-link  px-1" href="#snippets"><i class="fa fa-pie-chart" style={{ fontSize: '30px', color: 'pink', paddingRight: '10px' }}></i></a>
        </li>
        <li className="navbar-brand ml23">
          <a className="nav-link  px-1 mr-1" href="#articles"><i class="fa fa-bell" style={{ fontSize: '30px', color: 'pink', paddingRight: '10px' }}></i></a>
        </li>
        <li className="navbar-brand ml23">
          <a className="nav-link  px-1 mr-1" href="#articles"><i class="fa fa-user" style={{ fontSize: '30px', color: 'pink', paddingRight: '10px' }}></i></a>
        </li>
        <li className="navbar-brand ml23">
          <a className="nav-link  px-1 mr-1" href="#articles" id="HTML1-side-section-btn" onClick={showIndex}><i class="fa fa-list" style={{ fontSize: '30px', color: 'pink', paddingRight: '10px' }}></i></a>
        </li>
